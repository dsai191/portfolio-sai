...
export default function Banner(): React.JSX.Element {
  const texts = ["Software Engineer", "python developer", "UI/UX Designer", "React Native Developer"];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center ">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Sai Kiran</span>
                    </p>
                  </div>
              ...
              <Image
                src="/assets/me.png"
                alt="sai kiran - Software Engineer and Designer"
                width={300}
                height={300}
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="hidden lg:inline-block relative">
              <Image
                ...
                height={100}
                className="absolute "
                style={{ left: "-102px", top: "-60px", width: "auto", height: "auto" }}
              />
              <div style={{ bottom: 40, position: "relative" }}>
                <p className="text-white text-lg">
                  Hello! I Am{" "}
                  <span className="text-purple-400">D Sai kiran</span>
                </p>
              </div>
        ...
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
                   A self-driven web developer and aspiring UI/UX designer. 
                  With hands-on experience building responsive websites and apps, 
                  I focus on creating clean, modern interfaces that balance usability with visual appeal. 
                  My goal is to craft digital experiences that not only look polished but also 
